...
static void cpu_addressing_implied(nes_cpu_t *nes_cpu) 
{ 
	nes_cpu->additional_cycles = 0; 
}

static void cpu_addressing_accumulator(nes_cpu_t *nes_cpu) 
{ 
	nes_cpu->additional_cycles = 0; 
}
...
static void cpu_dec(nes_cpu_t *nes_cpu) {
    uint8_t tmp = nes_cpu->op_value - 1;
    memory_write_byte(nes_cpu, nes_cpu->op_address, tmp);
    cpu_checknz(nes_cpu, tmp);
}
...
static void cpu_nop(nes_cpu_t *nes_cpu) {}
...
{
    printf("PC:%04X opcode: %02x A:%02x X:%02x Y:%02x P:%02x SP:%02x CYC:%03ld\n", 
    	    nes_cpu->regs.PC, 
    	    opcode, 
    	    nes_cpu->regs.A, 
    	    nes_cpu->regs.X, 
...
void nes_cpu_run(nes_cpu_t *nes_cpu) 
{
    ...
    switch(opcode) {
        ...
        case 0x04: cpu_addressing_zeropage(nes_cpu);    cpu_nop(nes_cpu);  cycles += 1; break;
        ...
        case 0x0C: cpu_addressing_absolute(nes_cpu);    cpu_nop(nes_cpu);  cycles += 1; break;
        ...
        case 0x14: cpu_addressing_zeropage_x(nes_cpu);  cpu_nop(nes_cpu);  cycles += 1; break;
        ...
        case 0x1A: cpu_addressing_accumulator(nes_cpu); cpu_nop(nes_cpu);  cycles += 1; break;
        case 0x1C: cpu_addressing_absolute_x(nes_cpu);  cpu_nop(nes_cpu);  cycles += 1; break;
        ...
        case 0x28: cpu_addressing_implied(nes_cpu);     cpu_plp(nes_cpu);  cycles += 3; break;
        ...
        case 0x2D: cpu_addressing_absolute(nes_cpu);    cpu_and(nes_cpu);  cycles += 2; break;
        ...
        case 0x34: cpu_addressing_zeropage_x(nes_cpu);  cpu_nop(nes_cpu);  cycles += 1; break;
        ...
        case 0x3A: cpu_addressing_accumulator(nes_cpu); cpu_nop(nes_cpu);  cycles += 1; break;
        case 0x3C: cpu_addressing_absolute_x(nes_cpu);  cpu_nop(nes_cpu);  cycles += 1; break;
        ...
        case 0x44: cpu_addressing_zeropage(nes_cpu);    cpu_nop(nes_cpu);  cycles += 1; break;
        ...
        case 0x54: cpu_addressing_zeropage_x(nes_cpu);  cpu_nop(nes_cpu);  cycles += 1; break;
        ...
        case 0x5A: cpu_addressing_accumulator(nes_cpu); cpu_nop(nes_cpu);  cycles += 1; break;
        case 0x5C: cpu_addressing_absolute_x(nes_cpu);  cpu_nop(nes_cpu);  cycles += 1; break;
        ...
        case 0x64: cpu_addressing_zeropage(nes_cpu);    cpu_nop(nes_cpu);  cycles += 1; break;
        ...
        case 0x74: cpu_addressing_zeropage(nes_cpu);    cpu_nop(nes_cpu);  cycles += 1; break;
        ...
        case 0x7A: cpu_addressing_accumulator(nes_cpu); cpu_nop(nes_cpu);  cycles += 1; break;
        case 0x7C: cpu_addressing_absolute_x(nes_cpu);  cpu_nop(nes_cpu);  cycles += 1; break;
        ...
        case 0x80: cpu_addressing_immediate(nes_cpu);   cpu_nop(nes_cpu);  cycles += 1; break;
        ...
        case 0xA8: cpu_addressing_implied(nes_cpu);     cpu_tay(nes_cpu);  cycles += 3; break;
        ...
        case 0xB1: cpu_addressing_indirect_y(nes_cpu);  cpu_lda(nes_cpu);  cycles += 5; break;
        ...
        case 0xB9: cpu_addressing_absolute_y(nes_cpu);  cpu_lda(nes_cpu);  cycles += 4; break;
        case 0xBA: cpu_addressing_implied(nes_cpu);     cpu_tsx(nes_cpu);  cycles += 2; break;
        case 0xBC: cpu_addressing_absolute_x(nes_cpu);  cpu_ldy(nes_cpu);  cycles += 4; break;
        case 0xBD: cpu_addressing_absolute_x(nes_cpu);  cpu_lda(nes_cpu);  cycles += 4; break;
        case 0xBE: cpu_addressing_absolute_y(nes_cpu);  cpu_ldx(nes_cpu);  cycles += 4; break;
        ...
        case 0xD4: cpu_addressing_zeropage_x(nes_cpu);  cpu_nop(nes_cpu);  cycles += 1; break;
        case 0xD5: cpu_addressing_zeropage_x(nes_cpu);  cpu_cmp(nes_cpu);  cycles += 5; break;
        ...
        case 0xDA: cpu_addressing_accumulator(nes_cpu); cpu_nop(nes_cpu);  cycles += 1; break;
        case 0xDC: cpu_addressing_absolute_x(nes_cpu);  cpu_nop(nes_cpu);  cycles += 1; break;
        ...
        case 0xF4: cpu_addressing_zeropage_x(nes_cpu);  cpu_nop(nes_cpu);  cycles += 1; break;
        ...
        case 0xFA: cpu_addressing_accumulator(nes_cpu); cpu_nop(nes_cpu);  cycles += 1; break;
        case 0xFC: cpu_addressing_absolute_x(nes_cpu);  cpu_nop(nes_cpu);  cycles += 1; break;
